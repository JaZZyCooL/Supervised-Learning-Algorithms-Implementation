...
svc = SVC(gamma='auto', probability=(False), C=0.1, kernel='linear')
...
#gamma='auto', probability=(False), C=0.1, kernel='linear' - learning curve 1
#-----------------------------------------------------------------------------
#Learning Curve
...
for i in range(len(kernel)):
    svc = SVC(gamma='auto', probability=(False), C=0.1, kernel=kernel[i])
